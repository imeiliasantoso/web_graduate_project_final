...
def run():
    ...
    data_csv = load_csv.load_file(
        "/Users/imeiliasantoso/web_graduate_project5/predict_page/predict2_data_5.csv")

    saver = Saver("weka.core.converters.ArffSaver")
    saver.save_file(data_csv,
                    "/Users/imeiliasantoso/web_graduate_project5/predict_page/predict2_data_5.arff")
    ...
    saveFile = open("/Users/imeiliasantoso/web_graduate_project5/predict_page/predict2_data_5.txt", "w")
